...
class ResultData(object):
    ...
    def __init__(self, timestamp, test_name, vm, command, args=None, rite_result=None, rite_result_log=None, parsed_result=ResultStates.NONE, rite_failed=False, rite_fail_log=None, side=None):
    ...
    def parse_result(self):
        ...
        #crop case
        if self.command.strip() in cropping_commands and self.rite_result is False:
            self.parsed_result = ResultStates.CROP

        #fail and no sync case
        if self.command.strip() in failing_commands and self.rite_result is False:
