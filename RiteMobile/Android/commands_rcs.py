...
class CommandsRCS:
    ...
    def __init__(self, host, device_id, login_id = "0", login = "avmonitor", password = "testriteP123", operation = "Rite_Mobile", target_name = "HardwareFunctional", factory = 'RCS_0000002050', endpoint=None):
        self.host = host
        self.login = login
