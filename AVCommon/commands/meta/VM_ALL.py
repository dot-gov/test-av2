...
def execute(vm, protocol, level):
    ...
    vm_first = "eset7,avast,avast32,avg,avg15,panda15,avg32,avira,avira15,kis15,kis14,kis32,mcafee,bitdef15,norton,comodo,eset,msessential,panda,norton15".split(',')
    #disattivato DEFINITIVAMENTE kis (kis e' un kis 2013 che ormai non si usa piu')
    vm_second = "fortinet,drweb,360cn5,cmcav,adaware,fprot,bitdef,fsecure,gdata,vba32,iobit32,mbytes,risint,syscare,trendm,trendm15,zoneal,clamav,360ts,norman,ahnlab".split(',')
